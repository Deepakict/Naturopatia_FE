    ...
    >
      <div className="container flex items-center justify-between gap-6 py-4">
        ...
        <div className="flex items-center gap-3">
          <button
            type="button"
            className="flex h-10 w-10 items-center justify-center rounded-full border border-brand-mist bg-white text-brand-ink shadow-sm transition hover:border-brand-forest"
            aria-label="Cart"
          >
